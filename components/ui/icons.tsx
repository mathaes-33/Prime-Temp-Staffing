...
export const TwitterIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1-1-6.1-6.1 0-6.1z"></path><path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-6.1-1-6.1-6.1 0-6.1z"></path><path d="M15 17c-2.4-.2-4.6-1.5-6.5-3.3-2.5-2.2-4-5.3-4-5.3s-1.3 2.1 0 4.2c1.7 2.9 5.3 5.3 5.3 5.3s-2.1.2-4.2 0c-2.5-1.1-4.2-3.3-4.2-3.3s1.3 2.1 4.2 3.3c2.9 1.1 5.3 1.1 5.3 1.1s-.2 2.1 0 4.2c.2 2.5 2.5 4.2 2.5 4.2s-.2-2.1-1.1-4.2c-.9-2.2-2.2-4-3.3-5.3"></path></svg>
);
...
export const InboxIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><polyline points="22 12 16 12 14 15 10 15 8 12 2 12"></polyline><path d="M5.45 5.11 2 12v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2v-6l-3.45-6.89A2 2 0 0 0 16.76 4H7.24a2 2 0 0 0-1.79 1.11z"></path></svg>
);
